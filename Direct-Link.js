...
(() => {
  ...
  const hostRegex = /([\w.]{0,})(jianshu|juejin|youtube|leetcode|oschina|gitee|epicgames|adjust|shop-links|landiannews).(com|cn|org|net|co)/;
  ...
  (() => {
    ...
    const usingTarget = /([\w.]{0,})(juejin|leetcode|gitee).(com|cn)/.test(CUR_HOST);
